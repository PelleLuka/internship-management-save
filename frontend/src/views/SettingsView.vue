  ...
  <div class="p-6 max-w-xl mx-auto">
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
      ...
      <p class="text-sm text-slate-500 mb-4">
        Uploadez un fichier <strong>.docx</strong> avec les balises
        <code class="text-blue-600 bg-blue-50 px-1 rounded">{prenom}</code>,
        <code class="text-blue-600 bg-blue-50 px-1 rounded">{nom}</code>,
        <code class="text-blue-600 bg-blue-50 px-1 rounded">{date_debut}</code>,
        <code class="text-blue-600 bg-blue-50 px-1 rounded">{date_fin}</code>,
        <code class="text-blue-600 bg-blue-50 px-1 rounded">{#ateliers}{titre}{/ateliers}</code>,
        <code class="text-blue-600 bg-blue-50 px-1 rounded">{date_emission}</code>.
      </p>
