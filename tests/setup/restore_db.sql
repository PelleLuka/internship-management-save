...
INSERT INTO internship (id, person_id, start_date, end_date) VALUES
  ...
  -- 2-day internships dispersed across April / May / June 2026 (today = 2026-05-06)
  -- April (5) — all Terminé
  (100, 100, '2026-04-02', '2026-04-03'),
  (101, 101, '2026-04-09', '2026-04-10'),
  (102, 102, '2026-04-16', '2026-04-17'),
  (103, 103, '2026-04-23', '2026-04-24'),
  (104, 104, '2026-04-30', '2026-05-01'),
  -- May (5) — mixed: Terminé / En cours / À venir
  (105, 105, '2026-05-04', '2026-05-05'),  -- Terminé (ended yesterday)
  (106, 106, '2026-05-05', '2026-05-06'),  -- En cours (last day = today)
  (107, 107, '2026-05-06', '2026-05-07'),  -- En cours (today = first day)
  (108, 108, '2026-05-14', '2026-05-15'),  -- À venir
  (109, 109, '2026-05-25', '2026-05-26'),  -- À venir
  -- June (5) — all À venir
  (110, 110, '2026-06-02', '2026-06-03'),
  (111, 111, '2026-06-09', '2026-06-10'),
  (112, 112, '2026-06-16', '2026-06-17'),
  (113, 113, '2026-06-23', '2026-06-24'),
  (114, 114, '2026-06-29', '2026-06-30');
